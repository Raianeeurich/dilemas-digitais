...
const dilemmas = [
    ...
    {
        question:
            "Uma rede social oferece um aplicativo gratuito, mas pede acesso a todos os seus dados pessoais. Você aceita?",

        context:
            "O aplicativo promete facilitar sua vida, mas seus dados poderão ser utilizados para publicidade personalizada.",

        a:
            "Aceito. Quero utilizar o aplicativo.",

        b:
            "Não aceito. Prefiro proteger meus dados.",
    ...
    {
        question:
            "Você recebe uma notícia muito chocante em um grupo de mensagens. Você compartilha imediatamente?",

        context:
            "A notícia parece verdadeira, mas você não sabe quem publicou originalmente a informação.",

        a:
            "Compartilho para alertar outras pessoas.",

        b:
            "Verifico a informação antes de compartilhar.",
    ...
    {
        question:
            "Uma inteligência artificial fez grande parte de um trabalho escolar. Você entrega o trabalho como se tivesse feito tudo sozinho?",

        context:
            "A ferramenta produziu um texto de boa qualidade e você fez apenas pequenas alterações.",

        a:
            "Sim. O importante é o resultado final.",

        b:
            "Não. Informo que utilizei inteligência artificial.",
    ...
    {
        question:
            "Um colega está sofrendo ataques nas redes sociais. Você vê tudo acontecendo. O que faz?",

        context:
            "Os comentários são ofensivos e outras pessoas continuam compartilhando as mensagens.",

        a:
            "Não me envolvo. O problema não é meu.",

        b:
            "Denuncio e tento ajudar a pessoa.",
    ...
    {
        question:
            "Uma empresa oferece desconto em troca de rastrear sua localização constantemente. Você aceita?",

        context:
            "O desconto é significativo, mas a empresa poderá saber onde você está durante grande parte do dia.",

        a:
            "Aceito pelo desconto.",

        b:
            "Recuso para preservar minha privacidade.",
